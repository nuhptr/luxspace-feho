...
function accordion() {
    ...
    for (let index = 0; index < accordionContainer.length; index++) {
        ...
        addClass(
            button,
            "absolute block md:hidden transform right-0 -translate-y-1/2 focus:outline-none transition duration-200 rotate-0"
        )
...
//* Call the function if the window is less than 768px
